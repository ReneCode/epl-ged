...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InteractionList = __webpack_require__(3);

	var _TraceCoordinateInteraction = __webpack_require__(5);

	var _LineInteraction = __webpack_require__(6);

	var _DrawCanvas = __webpack_require__(8);

	var _DatabaseStore = __webpack_require__(9);

	var canvas = $("#canvas")[0];
	var rect = canvas.getBoundingClientRect();
	var targetCtx = canvas.getContext('2d');

	var drawCanvas = new _DrawCanvas.DrawCanvas(rect.right - rect.left, rect.bottom - rect.top);

	var databaseStore = new _DatabaseStore.DatabaseStore(drawCanvas);

	var interactionList = new _InteractionList.InteractionList(rect);

	//interactionList.add(new TraceCoordinateInteraction());
	interactionList.add(new _LineInteraction.LineInteraction(drawCanvas, databaseStore));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.InteractionList = undefined;
	...
	var InteractionList = exports.InteractionList = function () {
		function InteractionList(boundingRect) {
			_classCallCheck(this, InteractionList);

			this.interactions = [];
			this.boundingRect = boundingRect;
		}

		_createClass(InteractionList, [{
			key: "add",
			value: function add(ia) {
			...
			value: function mousemove(evt) {
				evt.preventDefault();
				var pt = new _Point.Point(evt.clientX - this.boundingRect.left, evt.clientY - this.boundingRect.top);
...
/***/ function(module, exports) {
	...
	var TraceCoordinateInteraction = exports.TraceCoordinateInteraction = function () {
	  function TraceCoordinateInteraction() {
	    _classCallCheck(this, TraceCoordinateInteraction);
	  }

	  _createClass(TraceCoordinateInteraction, [{
	    key: "mousemove",
	    value: function mousemove(pt) {
	      console.log(pt.x, pt.y);
	    }
	  }]);

	  return TraceCoordinateInteraction;
	}();
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LineInteraction = undefined;
	...
	var LineInteraction = exports.LineInteraction = function () {
	    function LineInteraction(drawCanvas, storeCanvas) {
	        _classCallCheck(this, LineInteraction);
	    ...
	    _createClass(LineInteraction, [{
	        key: 'mousemove',
	        value: function mousemove(pt) {
	            if (this._p1 == undefined) {
	                return;
	            }
	            this._drawCanvas.drawRubberLine(new _Line.Line(this._p1, pt));
	        }
	    }, {
	        key: 'click',
	        value: function click(pt) {
	            if (this._p1 == undefined) {
	                this._p1 = pt;
	            } else {
	                this._storeCanvas.addLine(new _Line.Line(this._p1, pt));
	                this._p1 = undefined;
	            }
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	var Line = exports.Line = function () {
	    ...
	    _createClass(Line, [{
	        key: "draw",
	        value: function draw(drawCanvas) {
...
/***/ function(module, exports) {
	...
	var DrawCanvas = exports.DrawCanvas = function () {
	    ...
	    _createClass(DrawCanvas, [{
	        key: 'redraw',
	        value: function redraw(targetCtx) {
	            if (!this._dirty) {
	                return;
	            }
	        ...
	        key: 'drawRubberLine',
	        value: function drawRubberLine(line) {
...
/***/ function(module, exports) {
	...
	var DatabaseStore = exports.DatabaseStore = function () {
	    function DatabaseStore(drawCanvas) {
	    ...
	    _createClass(DatabaseStore, [{
	        ...
	        key: "drawItems",
	        value: function drawItems(drawCanvas) {
...
/***/ function(module, exports) {
	...
	var CrossHairInteraction = exports.CrossHairInteraction = function () {
	    function CrossHairInteraction(boundingRect) {
	        _classCallCheck(this, CrossHairInteraction);

	        this.boundingRect = boundingRect;
	    }

	    _createClass(CrossHairInteraction, [{
	        key: "mousemove",
	        value: function mousemove(pt) {}
	    }]);

	    return CrossHairInteraction;
	}();
	...
	(function () {
	  ...
	  !function (a, b) {
	    ...
	    var c = [],
	      ...
	      } }), r.parseJSON = JSON.parse, "function" == "function" && __webpack_require__(13) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	      return r;
